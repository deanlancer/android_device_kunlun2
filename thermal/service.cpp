...
static int shutdown() {
    LOG(ERROR) << "Lenovo Thermal HAL Service is shutting down.";
    return 1;
}
...
int main(int /* argc */, char ** /* argv */) {
    ...
    LOG(INFO) << "Lenovo Thermal HAL Service 2.0 starting...";
    ...
    LOG(INFO) << "Lenovo Thermal HAL Service 2.0 started successfully.";
    joinRpcThreadpool();
